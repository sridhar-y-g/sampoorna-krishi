...
export const NAV_LINKS = [
  ...
  { href: '/agri-ecommerce', label: 'Agri E-Commerce', icon: ShoppingBag },
  { href: '/agri-vehicles', label: 'Agri Vehicles', icon: Truck },
  { href: '/animal-husbandry', label: 'Animal Husbandry', icon: PawPrint },
